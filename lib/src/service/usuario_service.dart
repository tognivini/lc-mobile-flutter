...
class UsuarioService extends AbstractService {
  Future<bool> login({required String email, required String senha}) async {
    ...
    final conteudo =
        json.encode(<String, String>{'login': email, 'senha': senha});
  ...
  //   UsuarioModel u1 =
  //       new UsuarioModel(email: 'paula@teste', senha: '123', nome: 'paula');
  //   UsuarioModel u2 = new UsuarioModel(
  //       email: 'angelica@teste', senha: '123', nome: 'angelica');
  //   UsuarioModel u3 = new UsuarioModel(
  //       email: 'gabriela@teste', senha: '123', nome: 'gabriela');
  //   UsuarioModel u4 =
  //       new UsuarioModel(email: 'luciana@teste', senha: '123', nome: 'luciana');
  //   UsuarioModel u5 =
  //       new UsuarioModel(email: 'naty@teste', senha: '123', nome: 'naty');
  //   //print(u.toString());
  //   // new UsuarioPersistence().salvar(u);
